...
<html>
   <head>
      ...
      <link rel="stylesheet" href="/resources/include/css/intro.css"/>
      <link rel="stylesheet" href="/resources/include/css/intrologin.css"/>
   ...
   <body>
  	...
  	<div id="login.page">	
  		...
  		<a href="mainpage_notlogin.html" class="myButton" id=main_home>Open Main Home</a>
